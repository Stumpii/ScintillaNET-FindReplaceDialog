namespace Demo
{
	partial class Form1
	{
		...
		private void InitializeComponent()
		{
			...
			this.enableCustomLineNumber = new System.Windows.Forms.CheckBox();
			...
			// 
			// enableCustomLineNumber
			// 
			this.enableCustomLineNumber.AutoSize = true;
			this.enableCustomLineNumber.Location = new System.Drawing.Point(268, 13);
			this.enableCustomLineNumber.Margin = new System.Windows.Forms.Padding(4, 3, 4, 3);
			this.enableCustomLineNumber.Name = "enableCustomLineNumber";
			this.enableCustomLineNumber.Size = new System.Drawing.Size(178, 19);
			this.enableCustomLineNumber.TabIndex = 5;
			this.enableCustomLineNumber.Text = "Enable Custom Line Number";
			this.enableCustomLineNumber.UseVisualStyleBackColor = true;
			this.enableCustomLineNumber.CheckedChanged += EnableCustomLineNumber_CheckedChanged;
			// 
			// Form1
			// 
			...
			this.Controls.Add(this.enableCustomLineNumber);
		...
		private System.Windows.Forms.CheckBox enableCustomLineNumber;
	}
}
